...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./audioPanel", "./lettreStatut"], factory);
    }
    ...
    var Grille = /** @class */ (function () {
        function Grille(longueurMot, maxPropositions, indice, configuration) {
            this._grille = document.getElementById("grille");
            this._audioPanel = new audioPanel_1.default(configuration);
